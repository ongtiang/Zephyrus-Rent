                                ...
                                if(isset($_GET['id']))
                                {
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        ...
                                        <form action="./code.php" method="POST">
                                            ...
                                            <div class="mb-3">
                                                <label>NIC</label>
                                                <input type="text" name="lname" value="<?=$row['lamne'];?>" class="form-control">
                                            </div>
                                            <div class="mb-3">
                                                <label>Email</label>
                                                <input type="email" name="age" value="<?=$row['age'];?>" class="form-control">
                                            </div>
                                            <div class="mb-3">
                                                <label>Phone</label>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="email" value="<?=$row['email'];?>" class="form-control">
                                            </div>
                                            <div class="mb-3">
                                                <label>Birthday</label>
                                                <input type="date" name="email" value="<?=$row['email'];?>" class="form-control">
