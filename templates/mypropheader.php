...
<body>
    <?php 
    //This file is also copy of header.php 
    // The difference in the file is 
    //The myproperties.php file required a dynamic updation of the request modal box 
    //So this file was created to meet the dynamic requirements of the file myproperties.php 
    //Checkout the header.php for the comments for these php block of code 
        include 'dbcon.php'  ;
    ...
    ?>
    <nav>
        <div class="logo"><img src = '../images/logo1.png' height="70" width="70">
        <div class="title"><b>Z</b>ephyrus&nbsp;<b>R</b>ent</div>
        </div>
